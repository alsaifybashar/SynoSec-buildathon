...
export const subdomainTools: ToolCatalogEntry[] = [
  ...
  { id: "assetfinder", displayName: "Assetfinder", binary: "assetfinder", category: "subdomain", riskTier: "passive", phase: "recon", osiLayers: ["L3", "L4", "L7"], tags: ["subdomain", "osint", "passive"] }
];
