  ...
  return (
    <Card className="border-border/70 bg-card/80">
      <CardHeader className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        ...
        {onAdd ? (
          <Button type="button" className="h-8 self-start text-[0.72rem]" onClick={onAdd}>
                  ...
                  <CardContent className="space-y-4 px-4 py-4">
                    ...
                    {hasRowActions ? (
                      <div className="flex flex-wrap gap-2 pt-1">
                        {onEdit ? (
                          <Button type="button" variant="outline" className="h-7 text-[0.72rem]" onClick={() => onEdit(row)}>
                            <Pencil className="h-3.5 w-3.5" />
                            Edit
                          </Button>
                        ) : null}
                        {onDelete ? (
                          <Button type="button" variant="outline" className="h-7 text-[0.72rem]" onClick={() => onDelete(row)}>
