...
describe("WorkflowsPage", () => {
  ...
  it("renders a guided evidence-first stage timeline", async () => {
    ...
    expect(screen.getAllByText("Main Action").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Evidence").length).toBeGreaterThan(0);
    expect(screen.getAllByText("What Happened Next").length).toBeGreaterThan(0);
